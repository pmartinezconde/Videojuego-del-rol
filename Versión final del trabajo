...
if(situacion==251)
{
	...
	if(decision=='1')
		{
	printf("Observas que hay una luz sobre tu cabeza\nAl mirar hacia arriba ves como esta a mucha altura, parece ser la luz del sol pasando por una grieta...\nDeduces que has caido por ahi, al ver varios escombros a tu alrededor\nTras acostumbrarte a la oscuridad de la sala, ves como la cueva sigue hacia delante\n");
	(*pi).pista1=1;
		}	
	if(decision=='3')
	{
