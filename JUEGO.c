    ...
    scanf("%c",&menunum);
    	if(menunum=='1')
    		{	
    			...
    			printf("Has elegido Guerrero Ataque: %i   Salud: %i    Defensa: %i\n",pers.atk,pers.hp,pers.def);
			}	
		else if(menunum=='2')
			{
				pers.atk=15;
    			...
    			printf("Has elegido Barbaro Ataque: %i   Salud: %i    Defensa: %i\n",pers.atk,pers.hp,pers.def);
			}
		else if(menunum=='3')	
			{
				pers.atk=6;
				...
				printf("Has elegido Guardian Ataque: %i   Salud: %i    Defensa: %i\n",pers.atk,pers.hp,pers.def);
			}
		else if(menunum=='4')
			{
				pers.atk=10;
    			...
    			printf("Has elegido Caballero Ataque: %i   Salud: %i    Defensa: %i\n",pers.atk,pers.hp,pers.def);
			}
    }break; 
    case '2':
    {
